        ...
        try {
            ...
            // Méthode 2: supabaseApp
                ...
                try {
                    ...
                    console.warn('Erreur auth supabaseApp:', authError);
                }
            }
            // Méthode 3: supabase global
                ...
                try {
                    ...
                    console.warn('Erreur auth supabase:', authError);
                }
            }

            if (!currentUserId) {
                console.warn('Missions: Utilisateur non connecté - mode démo');
                // Mode démo pour afficher quand même l'interface
